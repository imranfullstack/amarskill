...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['subtotal'] = $request->subtotal; # You cant not pay less than 10
        $post_data['total'] = $request->total; # You cant not pay less than 10
        $post_data['user_id'] = Auth::user()->id; # You cant not pay less than 10
        $post_data['payment_type'] = 'NULL'; # You cant not pay less than 10
        $post_data['cupon_discount'] = $request->discount; # You cant not pay less than 10
        $post_data['invoice_no'] = random_int(100000, 999999); # You cant not pay less than 10

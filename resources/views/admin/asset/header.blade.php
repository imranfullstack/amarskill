  <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            ...
            <div class="dark-logo-wrapper"><a href="{{route('admin.dashboard')}}"><img class="" src="{{asset('public/assets/images/logo/dark-logo.png')}}" alt=""></a></div>
          ...
          <div class="left-menu-header col">
            <ul>
              <li>
                <a href="{{URL('/')}}" class="btn btn-primary btn-sm" target="_blank">Visit Website</a>
              </li>
            </ul>
          </div>

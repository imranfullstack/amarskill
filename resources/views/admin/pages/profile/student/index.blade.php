...
$studentsd = App\Models\user::where('role_id',1)->count();
$instructorsd = App\Models\user::where('role_id',2)->count();
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Instructor</span>
                        <h4 class="mb-0 counter">{{$instructorsd}}</h4><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database icon-bg"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Students</span>
                        <h4 class="mb-0 counter">{{$studentsd}}</h4><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database icon-bg"><ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"></path><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path></svg>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <tbody>
          ...
          @foreach($students as $item)
            <tr>
              ...
              <td>{{ $item->phone }} </td>
              <td>
                <a href="{{route('admin.student.show',$item->id)}}" class="btn btn-primary">
                  <i class="fa fa-eye"></i>
                </a>
              </td>
            </tr>

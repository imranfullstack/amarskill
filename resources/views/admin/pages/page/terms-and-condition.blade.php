          ...
          <div class="row">
            ...
            <div class="col-md-6">             
              <div class="right-alagin">
                    <a class="btn-dkd42c" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#exampleModal" data-bs-original-title="" title="">New Terms and Conditions</a>
...
<form action="{{route('admin.pages.terms.store')}}" method="post">
	@csrf  
...
@php 
	$privicy = App\Models\Termsandcondition::get();
	$i = 1;
@endphp

              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Pending Course</li>
                  </ol>
                </div>
                <div class="col-sm-6">
                  <!-- Bookmark Start-->
...
@php 
    $course = App\Models\Course::orderby('id','desc')->where('status','0')->get();
  $i = 1;
@endphp             
...
@foreach($course as $item)   
                <tr>
                    ...
                    <td>
                      <a href="{{route('admin.courses.approve',$item->id)}}" class="btn btn-success"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></a>                      
                    </td>

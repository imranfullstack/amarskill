                      ...
                      <table id="example" class="display nowrap" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <form action="{{route('admin.courses.lesson.manage.update.order',$item->id)}}" method="post">
                                @csrf  
                                    <td>
                                        <input type="number" class="form-input" name="orderby" value="{{$item->orderby}}">
                                    </td>
                                    <td>
                              ...
                              <td>
                                  <a href="{{route('admin.courses.lesson.manage.edit',$item->id)}}" class="btn btn-primary">
                                    <i class="fa fa-edit"></i>
                                  </a>
                              </td>
                              <td>
                                  <a href="{{route('admin.courses.create.assignment',$item->id)}}" class="btn btn-primary">
  ...
  @csrf
                            ...
                            <table  class="table table-bordered" style="text-align: left;">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>
                                      <input type="text" class="form-control" name="lession_name" placeholder="Name" >
                                    </td>
                                  </tr>
                                  <tr>
                                    <td>
                                  ...
                                  <tr>
                                    <td>
                                      <input type="text" class="form-control" name="video_duration" placeholder="00:00:00" value="00:00:00">
                                      <span>HH:MM:SS</span>
                                    </td>
                                  </tr>
                                  <tr>

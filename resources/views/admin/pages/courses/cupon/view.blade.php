...
@endphp
                                  <tr>
                                    ...
                                    <td>
                                        <select class="js-example-basic-single " name="course" disabled>
...
<a href="{{route('admin.courses.coupons.add')}}" class="btn btn-primary btn-sm" style="width: 100%">Go Back</a>
                    </div>
                  </div>
                </div>
              </div>

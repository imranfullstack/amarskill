                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">             
                            <div class="right-alagin">
                              <a href="{{route('admin.courses.manage.list')}}" class="btn-dkd42c"> Back to Course List</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="card-body">
                        <form class="theme-form" action="{{route('admin.courses.store')}}" method="post" enctype="multipart/form-data">
                          @csrf
                      <!-- Single Form  Start -->

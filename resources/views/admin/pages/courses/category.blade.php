        ...
        <tbody>
          ...
          @foreach($category as $item)
            <tr>
                ...
                <td>
                  @if($item->image)
                    <img src="{{asset('public/img/upload/category/'.$item->image)}}" width="30px">
                  @else
                        <img src="{{asset('public/image-not-found.jpg')}}" width="30px">
                  @endif
                </td>
                <td>{{$item->name}}</td>
                <td>
                  ...
                  @php 
                    $count = App\Models\Course::where('coursecategory_id',$item->id)->count();
                  @endphp
                  <span>{{$count}}</span>
                </td>
                <td>

...
<form action="{{route('admin.courses.assignment.update',$assignment->id)}}" method="post" enctype='multipart/form-data'>
	@csrf
                  <div class="card-body">
                  	...
                  	<div class="form-aria-dkdl0c3sd">
                  		<div class="single-form">
	                  		...
	                  		<input type="text" placeholder="Assignment Title" name="title" class="form-control" value="{{$assignment->title}}">
                  		</div>
                  		<div class="single-form">
	                  		<label>Assignment File -

						@if($assignment->file)	                  			
	                  		 <a href="{{asset('img/upload/assignment/'.$assignment->file)}}">View PDF</a>
	                  	@endif
	                  		</label>

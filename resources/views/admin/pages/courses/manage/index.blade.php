              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <td>{{Str::limit($course->course_title, 20, $end='...')}} </td>

                    
					              <td>
					                <a href="{{route('admin.courses.edit',$course->id)}}" class="btn btn-secendary">
					                  <i class="fa fa-edit"></i>
					                </a>
					              </td>
					              <td>
					                  <a href="{{route('admin.courses.section.view',$course->id)}}" class="btn btn-secendary">
					                    <i class="fa fa-plus"></i>
					                  </a>
					              </td>
					              <td>
					                  <a href="{{route('admin.courses.manage.section',$course->id)}}" class="btn btn-secendary">
					                    <i class="fa fa-plus"></i>
					                  </a>
					              </td>
					              <td>
...
<iframe width="100%" height="325px" src="https://www.youtube.com/embed/MppcBSqVW70" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

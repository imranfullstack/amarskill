            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="left-section-banner">
                        ...
                        <ul>
                            <li><i class="fa fa-user"></i> By <a href="#" style="color: #fff"><b>{{$course->user->name}}</b></a></li>
...
@if($lession->video_type == 1)
	@if($lession->lock == 1 )
		<iframe width="100%" height="250" src="{{$lession->video_url}}?modestbranding=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	@endif
@else
    <iframe src="{{$lession->video_url}}" height="250px" width="100%" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
@endif
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v12.0" nonce="71nrz2JQ">

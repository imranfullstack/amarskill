  <div class="page-main-header">
        <div class="main-header-right row m-0">
          <div class="main-header-left">
            <div class="logo-wrapper"><a href="{{route('admin.dashboard')}}"><img class="img-fluid" src="{{asset('/public/assets/images/logo/logo.png')}}" alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="index.html"><img class="" src="{{asset('/public/assets/images/logo/dark-logo.png')}}" alt=""></a></div>
          ...
          <div class="left-menu-header col">
            <ul>
              <li>
                <a class="btn btn-primary btn-sm" target="_blank" href="{{url('/')}}">View Site</a>
              </li>
            </ul>
          </div>
            ...
            <ul class="nav-menus">
              ...
              <li class="onhover-dropdown">
                ...
                <ul class="chat-dropdown onhover-show-div">
                  ...
                  <a class="dropdown-item btn btn-primary-light" href="{{ route('logout') }}"

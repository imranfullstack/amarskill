...
@endphp
                  ...
                  <br>
                  <h4 style="text-align: center;">ADD NEW FAQ</h4>
                  <br>

<form method="post" action="{{route('instructor.course.faq.store')}}">
	@csrf
                		...
                		<!-- ---- Single Course --- -->
                			<div class="single-lable">
                				...
                				<textarea class="form-control" rows="3" placeholder="Type Description ... " name="description"></textarea>
                		...
                		<!-- ---- Single Course --- -->
                			<div class="single-lable">
                				...
                				<input type="number" class="form-control" placeholder="Number ... " name="orderby">
                			</div>
                		<!-- ---- Single Course End--- -->
                		<br>
                		<!-- ---- Single Course --- -->

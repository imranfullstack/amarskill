          ...
          <div class="row">
            ...
            <div class="col-md-6">             
              <div class="right-alagin">
                    <a class="btn-dkd42c" href="{{route('instructor.course.create')}}">ADD New Course</a>
...
@include('instructor.asset.message')
<br>
<br>
              <!-- ----- 3rd Row --- -->
...
@foreach($course as $item)   
                <tr>
                    ...
                    <td>
                      <a href="{{route('instructor.course.edit',$item->id)}}" class="btn btn-secondary"><i class="fa fa-edit"></i></a>                      
                    </td>
                    <td>
                      <a href="{{route('instructor.course.manage.index',$item->slug)}}" class="btn btn-success">

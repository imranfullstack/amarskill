                      ...
                      <table id="example" class="display nowrap" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  ...
                                  <th class="col-width-56d3c">Add Assignment</th>
                              </tr>
                          </thead>
                          <tfoot>
                              <tr>
                              ...
                              @foreach($section as $item)
                                  <tr>
                                      ...
                                      <td>{{$item->title}}</td>                                  
                                        ...
                                        <td>
                                            <a href="{{route('instructor.course.manage.asssiment.lession',$item->id)}}" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                        </td>
                                  </tr>
                              @endforeach                    
                          </tbody>

                      ...
                      <table id="example" class="display nowrap" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  ...
                                  <th class="col-width-56d3c">Add Lession</th>
                              </tr>
                          </thead>
                          <tfoot>
                              <tr>
                                  <th>SL</th>
                                  <th>Lession Name</th>
                                  <th class="col-width-56d3c" width="70px">Action</th>
                                  <th class="col-width-56d3c">Order By</th>
                                  <th class="col-width-56d3c">Edit</th>
                                  <th class="col-width-56d3c">Add Lession</th>
                              </tr>
                          ...
                          <tbody>
                              ...
                              @foreach($section as $item)
                                  <tr>
                                      <th>{{$i++}}</th>
                                      <td>{{$item->title}}</td>
                                        <form action="{{route('instructor.course.manage.section.updateorder',$item->id)}}" method="post">
                                          @csrf
                                              <td>
                                                  <input type="number" class="form-control" name="order" value="{{$item->short_order}}">
                                              </td>
                                              <td>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="{{route('instructor.course.manage.section.edit',$item->id)}}">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                     
                                        </td>                                  
                                        <td>
                                            <a href="{{route('instructor.course.manage.lession.index',$item->id)}}" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                        </td>
                                  </tr>
                              @endforeach                    
                          </tbody>
...
<form action="{{route('instructor.course.manage.section.store',$id)}}" method="post" enctype='multipart/form-data'>
    @csrf
                  <div class="card-body">
                    <h6> <i class="fa fa-plus"></i> New Section</h6>
                    <br>
                    <div class="form-aria-dkdl0c3sd">
                      <!-- ------ Single Form ------- -->
                      <div class="single-form">
                        <label>Section Title</label>
                        <input type="text" placeholder="Section Title" name="title" class="form-control" required>
                      </div>
                      <!-- ------ Single Form --------->
                      <div class="single-form">

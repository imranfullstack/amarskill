...
<form action="{{route('instructor.course.manage.section.update',$section->id)}}" method="post">
  @csrf
                  <div class="card-body">
                    <h6> <i class="fa fa-edit"></i> Update Section</h6>
                    <br>
                    <div class="form-aria-dkdl0c3sd">
                      <!-- ------ Single Form ------- -->
                      <div class="single-form">
                        <label>Update Title</label>
                        <input type="text" placeholder="Section Title" name="title" value="{{$section->title}}" class="form-control" required>
                      </div>
                      <!-- ------ Single Form ------- -->
                      <div class="single-form">
                        <input type="submit" value="UPDATE" name="" class="btn btn-primary btn-ddfdjdd0">
                      </div>
                    </div>
                  </div>
</form>                  

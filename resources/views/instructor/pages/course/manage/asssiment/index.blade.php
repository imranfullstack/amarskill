                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="example" class="display nowrap" cellspacing="0" width="100%">
                          ...
                          @php $i = 1  @endphp 
                          @foreach($asssiment as $item)
                          	<tr>
                          		<td>{{$i++}}</td>
                          		<td>{{$item->title}}</td>
                          		<td>
                          			<a href="{{route('instructor.course.manage.asssiment.delete',$item->id)}}" class="btn btn-danger">
...
<form action="{{route('instructor.course.manage.asssiment.store',$lessiontid)}}" method="post" enctype='multipart/form-data'>
  @csrf
                  <div class="card-body">
                    <h6> <i class="fa fa-plus"></i> New Asssiment</h6>
                    <br>
                    <div class="form-aria-dkdl0c3sd">
                    <!-- ------- Single Form ---------->
	                      <div class="single-form">
	                        <label>Asssiment Thumbnail</label>
                    ...
                    <!-- ------- Single Form ---------->
	                      <div class="single-form">
	                        <label>Asssiment Name</label>
	                        <input type="text" placeholder="lession name" name="lessionname" class="form-control" required>
	                        @error('lessionname')  <p class="text-danger">{{$message}}</p>  @enderror
	                      </div>
                    <!-- ------- Single Form End---------->
                      <div class="single-form">
